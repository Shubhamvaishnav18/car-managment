...
export default function DashboardLayout({ children }) {
  return (
    <div className="flex flex-col h-screen bg-[#F8FAFC] font-sans antialiased text-slate-900 overflow-hidden">
      ...
      {/* 1. TOP HEADER (Full Width - Kept from your original code) */}
        ...
        <div className="flex items-center space-x-5">
          <div className="relative">
            ...
            <input
              ...
              className="bg-slate-100 border-none rounded-md font-[Inter] pl-10 pr-4 py-1.5 text-sm outline-none w-64 focus:ring-1 focus:ring-slate-300 transition-shadow"
            />
          </div>
          <button className="text-slate-500 hover:text-[#0F294D] transition-colors flex items-center">
      ...
      {/* 2. MAIN LAYOUT (Sidebar + Children Content) */}
      <div className="flex flex-1 overflow-hidden">

        {/* SIDEBAR (Pixel Perfect Target Design) */}
        <aside className="w-64 bg-slate-100 border-r border-slate-200/50 hidden md:flex flex-col p-4 gap-y-2 overflow-y-auto z-10">
          ...
          <div className="mt-auto pt-4 border-t border-slate-200/50 space-y-1">
            ...
            <Link href="/login" className="flex items-center gap-3 px-4 py-2 font-[Manrope] text-xs font-semibold uppercase tracking-widest text-slate-500 hover:text-red-600 transition-all">
