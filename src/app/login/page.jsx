...
export default function LoginPage() {
    const handleLogin = (e) => {
        e.preventDefault();
        // Dummy login: Set cookie so middleware allows access
        document.cookie = "auth-token=demo123; path=/";
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input type="email" placeholder="name@precision.com" className="pl-10 bg-slate-50 font-[Inter] border-none h-12" required />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input type="password" placeholder="••••••••" className="pl-10 bg-slate-50 font-[Inter] border-none h-12" required />
                            </div>
                        </div>
                        ...
                        <Button type="submit" className="w-full font-[Manrope] rounded-sm bg-[#0F294D] hover:bg-[#0B1727] text-white h-12">
                            Log In &rarr;
                        </Button>
                    </form>
